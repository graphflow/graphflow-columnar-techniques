...
public abstract class AbstractRunner {
     ...
     */
    protected static String sanitizeDirStringAndMkdirIfNeeded(String userDefinedDirectory)
        throws IOException {
        var outputDirectory = sanitizeDirStr(userDefinedDirectory);
     ...
     * @param options The setProperties of {@link Options} to parseQuery the args.
