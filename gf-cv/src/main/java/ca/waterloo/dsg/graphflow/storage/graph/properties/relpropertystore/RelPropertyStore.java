...
import ca.waterloo.dsg.graphflow.storage.graph.properties.relpropertystore.relpropertylists.RelPropertyList;
...
public class RelPropertyStore implements Serializable {
    ...
    public void setProperties(int relLabel, int srcVertexType, long srcNodeOffset,
        ...
        while (tokensIterator.hasMoreTokens()) {
            ...
            var propertyList = getPropertyList(relLabel, srcVertexType,
