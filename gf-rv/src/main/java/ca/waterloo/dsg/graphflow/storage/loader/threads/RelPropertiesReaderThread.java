...
public class RelPropertiesReaderThread implements Runnable {
    ...
    UnstructuredRelPropertyStore relPropertyStore;
    ...
    public RelPropertiesReaderThread(char separator, long[][] numLinesInBlock, UnstructuredRelPropertyStore relPropertyStore,
    ...
    private void execute() {
        ...
        try {
            ...
            if (EnumerationType.BY_SRC_OFFSETS == enumerationType) {
            ...
            } else if (EnumerationType.BY_DST_OFFSETS == enumerationType) {
                while (linesIterator.hasNextLine()) {
                    var tokenIterator = linesIterator.nextLineTokensIterator();
                ...
                throw new IllegalArgumentException("mar jao");
            }
        } catch (IOException e) {
