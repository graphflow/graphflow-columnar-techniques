...
public class BucketOffsetManager implements Serializable {
    ...
    public BucketOffsetManager(long numVertices) {
        ...
        var numBucketSlots = (int) (numBuckets / NUM_BUCKETS_PER_SLOT) + 1;
        ...
        numElementsInEachBucket[numBucketSlots - 1] =
            new int[(int) (numBuckets % NUM_BUCKETS_PER_SLOT)];
    }
    ...
    public static long getBucketID(long vertexId) {
        return (vertexId / BUCKET_SIZE);
    }
