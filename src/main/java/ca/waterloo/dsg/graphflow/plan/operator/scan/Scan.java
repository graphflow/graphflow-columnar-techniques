...
public class Scan extends Operator implements Serializable {
    ...
    public Scan(NodeVariable nodeVariable, boolean resetSelector) {
        ...
        this.operatorName = "Scan: " + nodeVariable.getVariableName() + ".ID";
    ...
    public void initFurther(Graph graph) {
        ...
        this.dataChunks.addVarToPosEntry(nodeVariable.getVariableName(), 0 /* dataChunkPos*/,
            0 /* vectorPos */);
    }
    ...
    @Override
    public ScanBlocking copy() {
        return new ScanBlocking(nodeVariable, resetSelector);
    }
}
