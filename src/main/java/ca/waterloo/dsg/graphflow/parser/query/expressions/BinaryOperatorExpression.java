...
public abstract class BinaryOperatorExpression extends Expression {
    ...
    public BinaryOperatorExpression(String variableName) {
        super(variableName);
    }

    public BinaryOperatorExpression(Expression leftExpression, Expression rightExpression) {
        super("");
    ...
    public boolean hasDependentFunctionInvocations() {
        return leftExpression.hasDependentFunctionInvocations() ||
            rightExpression.hasDependentFunctionInvocations();
    }
