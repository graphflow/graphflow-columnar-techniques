...
public class Enumerator {
    ...
    public List<Operator> generatePlans() {
        var nodes = query.getInputSchemaMatchWhere().getMatchGraphSchema().getNodeVariables();
...
//                        var dataChunkPos = currSchema.getDataChunkPos(
//                                propertyVar.getNodeOrRelVariable().getVariableName());
                        var isNodeProperty = propertyVar.getNodeOrRelVariable() instanceof NodeVariable;
...
//                    var dataChunkPos = schema.getDataChunkPos(
//                        ((PropertyVariable) propertyVar).getNodeOrRelVariable().getVariableName());
//                    lastOperator = NodePropertyReader.make(((PropertyVariable) propertyVar),
                    var varName =
                            ((PropertyVariable) propertyVar).getNodeOrRelVariable().getVariableName();
